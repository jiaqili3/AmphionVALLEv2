...
class VALLECollator():
    ...
    def __call__(self, batch):
        ...
        packed_batch_features['speech_len'] = torch.tensor([len(s) for s in speeches], dtype=torch.long)
        ...
        packed_batch_features['phone_ids'] = pad_sequence(phones, batch_first=True, padding_value=0)
